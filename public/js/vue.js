...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            selected_items: [],
            folder_name: '',
            folder_name_error: false,
            folder_name_success: false
        };
    },

    computed: {
        last_folder_id: function last_folder_id() {
    ...
    methods: {
        ...
        openFolder: function openFolder(parent_id) {
            if (this.breadcrumbs.indexOf(parent_id)) {
            ...
            this.getFolders(parent_id);
            this.getFiles(parent_id);
        },
        getFolders: function getFolders(parent_id) {
            this.$http.get('/api/folders/' + parent_id).then(function (response) {
        ...
        getFiles: function getFiles(folder_id) {
            this.$http.get('/api/files/' + folder_id).then(function (response) {
                files = response.body;
        ...
        createFolder: function createFolder() {
            if (this.folder_name != '') {
                ...
                this.$http.post('/api/folder/', data).then(function (response) {
                    this.$set('folder_name_success', true);
                    this.$set('folder_name_error', false);
                    this.openFolder(this.current_folder_id);
                }, function (response) {
                    this.$set('folder_name_success', false);
                    this.$set('folder_name_error', 'Mappe Eksisterer allerede');
                });
            } else {
                this.$set('folder_name_success', false);
                this.$set('folder_name_error', 'Mangler Mappe Navn');
            }
        },
...
},{"./components/FileBrowser.vue":6,"vue":4,"vue-resource":3}]},{},[7]);
